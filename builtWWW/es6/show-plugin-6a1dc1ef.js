...
import { g as doAddPluginUrl, r as request, h as api, j as createTransaction$1, p as processTransaction$1, k as Epml } from './typography-fae8185b.js';
import { h as html, d as dom, P as Polymer } from './iron-a11y-keys-behavior-e282ce25.js';
import { I as IronOverlayBehavior } from './iron-overlay-behavior-f2ec786a.js';
...
class ShowPlugin extends connect(store)(LitElement) {
    ...
    stateChanged(state) {
        ...
        if (split[0] === "" && split[1] === "" && split[2] === undefined) {
            this.url = 'wallet';
        } else if (split[1] === 'app') {
            this.url = split[2];
        } else {
...
//# sourceMappingURL=show-plugin-6a1dc1ef.js.map
