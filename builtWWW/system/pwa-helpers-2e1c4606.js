System.register([], function (exports) {
            ...
            return {
                        execute: function () {
                                    ...
                                    var global$1 = exports('l', (typeof global !== "undefined" ? global :
                                    ...
                                    const INIT_WORKERS = exports('I', 'INIT_WORKERS');
                                    const LOG_IN = exports('f', 'LOG_IN');
                                    const LOG_OUT = exports('g', 'LOG_OUT');
                                    const ADD_PLUGIN_URL = exports('j', 'ADD_PLUGIN_URL');
                                    const ADD_PLUGIN = exports('i', 'ADD_PLUGIN');
                                    const NAVIGATE = exports('k', 'NAVIGATE');
                                    const SELECT_ADDRESS = exports('S', 'SELECT_ADDRESS');
                                    const NETWORK_CONNECTION_STATUS = 'NETWORK_CONNECTION_STATUS';

                                    const initWorkersReducer = (state, action) => {
                                    ...
                                    var app = (state = INITIAL_STATE, action) => {
                                        switch (action.type) {
                                            case INIT_WORKERS:
                                    ...
                                    const saveStateToLocalStorage = exports('b', (key, state) => {
                                        try {
                                    ...
                                    const LOAD_CONFIG_FROM_API = 'LOAD_CONFIG_FROM_API';
                                    ...
                                    const doLoadConfigFromAPI = exports('e', () => {
                                    ...
                                    const loadConfigFromAPI$1 = (state, action) => {
                                        switch (action.status) {
                                            case 'success':
                                    ...
                                    var config$1 = (state = loadStateFromLocalStorage('config') || DEFAULT_INITIAL_STATE, action) => {
                                        switch (action.type) {
                                            case LOAD_CONFIG_FROM_API:
                                                return loadConfigFromAPI$1(state, action)
                                            case SET_NODE:
                                    ...
                                    const STORE_WALLET = exports('v', 'STORE_WALLET');
                                    const CLAIM_AIRDROP = 'CLAIM_AIRDROP';
                                    const UPDATE_ACCOUNT_INFO = 'UPDATE_ACCOUNT_INFO';

                                    const DEFAULT_INITIAL_STATE$1 = {
                                        storedWallets: {},
                                    ...
                                    var user = (state = loadStateFromLocalStorage('user') || DEFAULT_INITIAL_STATE$1, action) => {
                                        switch (action.type) {
                                            case STORE_WALLET:
                                                return {
                                                    ...state,
                                    ...
                                    const store = exports('s', createStore(
                                        reducers,
                                        composeEnhancers(
                                     ...
                                     * });
                                     */
                                    const directive = exports('d', (f) => ((...args) => {
                                        const d = f(...args);
                                     ...
                                     */
                                    const html = exports('h', (strings, ...values) => new TemplateResult(strings, values, 'html', defaultTemplateProcessor));
                                     ...
                                     */
                                    const customElement = exports('a', (tagName) => (classOrDescriptor) => (typeof classOrDescriptor === 'function') ?
                                     ...
                                     *     }
                                     */
                                    const eventOptions = exports('w', (options) => 
            ...
            take care to ensure page security.`);
                                     ...
                                     */
                                    const css = exports('c', (strings, ...values) => {
                                    ...
                                    */
                                    const installRouter = exports('r', (locationUpdatedCallback) => {
                                    ...
                                    */
                                    const connect = exports('u', (store) => (baseElement) => class extends baseElement {
                                        connectedCallback() {
...
//# sourceMappingURL=pwa-helpers-2e1c4606.js.map
