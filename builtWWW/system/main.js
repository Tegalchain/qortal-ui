System.register(['./default-theme-98ddfc53.js', './pwa-helpers-a45486d2.js', './typography-b460222a.js', './components/main-app.js', './styles/app-styles.js', './styles/app-theme.js', './components/login-view/login-view.js', './iron-a11y-keys-behavior-c9affbac.js', './mwc-icon-f02bf855.js', './loading-ripple-42f44db6.js', './iron-a11y-announcer-6198e940.js', './FileSaver.min-5dceff4d.js', './paper-ripple-99c84c5f.js', './mwc-icon-button-177c1380.js', './components/login-view/create-account-section.js', './paper-spinner-lite-21792fca.js', './components/login-view/login-section.js', './show-plugin-1c8cb41b.js', './iron-overlay-behavior-d47655ec.js', './components/app-view.js', './components/wallet-profile.js', './components/sidenav-menu.js'], function () {
  'use strict';
