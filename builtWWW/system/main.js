System.register(['./default-theme-c2e387b7.js', './pwa-helpers-a2ecbfbd.js', './typography-fcf6d834.js', './components/main-app.js', './styles/app-styles.js', './styles/app-theme.js', './components/login-view/login-view.js', './iron-a11y-keys-behavior-c9affbac.js', './mwc-icon-b53ebfd2.js', './loading-ripple-2ea640ce.js', './iron-a11y-announcer-dc2e8efe.js', './FileSaver.min-f927e2bf.js', './paper-ripple-99c84c5f.js', './mwc-icon-button-179513db.js', './components/login-view/create-account-section.js', './paper-spinner-lite-68a3e1a4.js', './components/login-view/login-section.js', './show-plugin-a6cf57f9.js', './iron-overlay-behavior-86229224.js', './components/app-view.js', './components/wallet-profile.js', './components/sidenav-menu.js'], function () {
  'use strict';
