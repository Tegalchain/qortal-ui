System.register(['./default-theme-cc48de01.js', './pwa-helpers-b8803d22.js', './typography-bad221cc.js', './components/main-app.js', './styles/app-styles.js', './styles/app-theme.js', './components/login-view/login-view.js', './iron-a11y-keys-behavior-17f3f126.js', './mwc-icon-a3cde566.js', './loading-ripple-18b8235f.js', './iron-a11y-announcer-6506206b.js', './FileSaver.min-1db86b76.js', './paper-ripple-1db8d130.js', './mwc-icon-button-0b515f06.js', './components/login-view/create-account-section.js', './paper-spinner-lite-5d2340d5.js', './components/login-view/login-section.js', './show-plugin-4b421031.js', './iron-overlay-behavior-67fa3e2b.js', './components/app-view.js', './components/wallet-profile.js', './components/sidenav-menu.js'], function () {
  'use strict';
