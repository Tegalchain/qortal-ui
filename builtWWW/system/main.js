System.register(['./default-theme-67574b66.js', './pwa-helpers-57ad2665.js', './typography-b694936e.js', './components/main-app.js', './styles/app-styles.js', './styles/app-theme.js', './components/login-view/login-view.js', './iron-a11y-keys-behavior-4a065f04.js', './mwc-icon-20e04fd4.js', './loading-ripple-cc277022.js', './iron-a11y-announcer-714302f5.js', './FileSaver.min-6376027c.js', './paper-ripple-5cd03b87.js', './mwc-icon-button-c6111c24.js', './components/login-view/create-account-section.js', './paper-spinner-lite-98677b37.js', './components/login-view/login-section.js', './show-plugin-a0d1414f.js', './iron-overlay-behavior-28d489c2.js', './components/app-view.js', './components/wallet-profile.js', './components/sidenav-menu.js'], function () {
  'use strict';
  ...
  return {
    setters: [function (module) {
      ...
      store$2 = module.s;
      saveStateToLocalStorage = module.b;
      doLoadConfigFromAPI = module.e;
    }, function (module) {
      initApi = module.i;
      doInitWorkers = module.d;
    ...
    execute: function () {
      ...
      */
      ...
      const oldState = store$2.getState();
      for (const key of keys$4) {
          oldReducers[key] = oldState[key];
      }

      store$2.subscribe(() => {
          const newState = store$2.getState();
          keys$4.forEach(key => {
              if (newState[key] !== oldState[key]) {
                  saveStateToLocalStorage(key, store$2.getState()[key]);
              }
          });
      });
      ...
      const workerInitChecker = () => {
          ...
          if (state.config.loaded) {
              ...
              if (state.app.workers.ready) {
                  ...
                  if (!state.app.workers.loading) store$2.dispatch(doInitWorkers(state.config.crypto.kdfThreads, state.config.user.constants.workerURL));
