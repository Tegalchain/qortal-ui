System.register(['./default-theme-f4872173.js', './pwa-helpers-e04d8fac.js', './typography-5bee746d.js', './components/main-app.js', './styles/app-styles.js', './styles/app-theme.js', './components/login-view/login-view.js', './iron-a11y-keys-behavior-c9affbac.js', './mwc-icon-b1620148.js', './loading-ripple-c16f03b5.js', './iron-a11y-announcer-b4b56881.js', './FileSaver.min-be8d0938.js', './paper-ripple-99c84c5f.js', './mwc-icon-button-894e1099.js', './components/login-view/create-account-section.js', './paper-spinner-lite-1456450e.js', './components/login-view/login-section.js', './show-plugin-7038e1dd.js', './iron-overlay-behavior-914e647b.js', './components/app-view.js', './components/wallet-profile.js', './components/sidenav-menu.js'], function () {
  'use strict';
